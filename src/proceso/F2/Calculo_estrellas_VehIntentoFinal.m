function [cosalidaconductorveh,cosalidacopilotoveh,coperdidacontrolveh,coadelantamientoveh,cointerseccionveh,copropiedadesveh,EstVehiculo,EstMotocicleta,EstCiclista,EstPeaton,EstVehicul,EstMoto,EstCicl,EstPeato]=Calculo_estrellas_VehIntentoFinal(x)
...
cosalidaconductorveh.anchocarril=[];
cosalidaconductorveh.curvatura=[];
cosalidaconductorveh.calidad_de_curva=[];
cosalidaconductorveh.delineacion=[];
cosalidaconductorveh.bandas_sonoras_espaldon=[];
cosalidaconductorveh.condicion_de_via=[];
cosalidaconductorveh.pendiente=[];
cosalidaconductorveh.resistencia_al_deslizamiento=[];
cosalidaconductorveh.severidad_lateral_distancia_conductor=[];
cosalidaconductorveh.severidad_lateral_objeto_conductor=[];
cosalidaconductorveh.ancho_de_berma=[];
cosalidaconductorveh.influencia_flujo_externo=[];
cosalidaconductorveh.transitabilidad_media=[];
cosalidaconductorveh.velocidad_operacion=[];
cosalidaconductorveh.clasificacion_salida_del_camino_lado_conductor=[];
cosalidaconductorveh.anchocarril=anchocarril;
cosalidaconductorveh.curvatura=curvatura2;
cosalidaconductorveh.calidad_de_curva=calidadcurva2;
cosalidaconductorveh.delineacion=delineacion;
cosalidaconductorveh.bandas_sonoras_espaldon=bandasonoraes;
cosalidaconductorveh.condicion_de_via=estadosuperficie2;
cosalidaconductorveh.pendiente=pendiente;
cosalidaconductorveh.resistencia_al_deslizamiento=resdeslizamiento2;
cosalidaconductorveh.severidad_lateral_distancia_conductor=distconductor2;
cosalidaconductorveh.severidad_lateral_objeto_conductor=objconductor2;
cosalidaconductorveh.ancho_de_berma=anchoespaldon2;
cosalidaconductorveh.influencia_flujo_externo=flujoext;
cosalidaconductorveh.transitabilidad_media=transitabilida;
cosalidaconductorveh.velocidad_operacion=veloperacion;
cosalidaconductorveh.clasificacion_salida_del_camino_lado_conductor=A;
cosalidaconductorveh=[anchocarril,curvatura2,delineacion,bandasonoraes,estadosuperficie2,pendiente,resdeslizamiento2,distconductor2,objconductor2,anchoespaldon2,flujoext,transitabilida,veloperacion,A];
%Salida del camino (lado del copiloto) Coeficientes2
cosalidacopilotoveh.anchocarril=anchocarril;
cosalidacopilotoveh.curvatura=curvatura2;
cosalidacopilotoveh.calidad_de_curva=calidadcurva2;
cosalidacopilotoveh.delineacion=delineacion;
cosalidacopilotoveh.bandas_sonoras_espaldon=bandasonoraes;
cosalidacopilotoveh.condicion_de_via=estadosuperficie2;
cosalidacopilotoveh.pendiente=pendiente;
cosalidacopilotoveh.resistencia_al_deslizamiento=resdeslizamiento2;
cosalidacopilotoveh.severidad_lateral_distancia_copiloto=distcopiloto2;
cosalidacopilotoveh.severidad_lateral_objeto_copiloto=objcopiloto2;
cosalidacopilotoveh.ancho_de_berma=anchoespaldoncop2;
cosalidacopilotoveh.influencia_flujo_externo=flujoext;
cosalidacopilotoveh.transitabilidad_media=transitabilida;
cosalidacopilotoveh.velocidad_operacion=veloperacion;
cosalidacopilotoveh.clasificacion_salida_del_camino_lado_copiloto=B;
cosalidacopilotoveh=[anchocarril,curvatura2,delineacion,bandasonoraes,estadosuperficie2,pendiente,resdeslizamiento2,distcopiloto2,objcopiloto2,anchoespaldoncop2,flujoext,transitabilida,veloperacion,B];
%Choque Frontal (perdida del control) Coeficientes3
coperdidacontrolveh.anchocarril=anchocarril;
coperdidacontrolveh.curvatura=curvatura2;
coperdidacontrolveh.calidad_de_curva=calidadcurva2;
coperdidacontrolveh.delineacion=delineacion;
coperdidacontrolveh.bandas_sonoras_central=bandassonoras;
coperdidacontrolveh.condicion_de_via=estadosuperficie2;
coperdidacontrolveh.pendiente=pendiente;
coperdidacontrolveh.resistencia_al_deslizamiento=resdeslizamiento2;
coperdidacontrolveh.tipo_de_mediana=tipomediana2;
coperdidacontrolveh.influencia_flujo_externo=flujoext1;
coperdidacontrolveh.transitabilidad_media=transitabilida;
coperdidacontrolveh.velocidad_operacion=veloperacion1;
coperdidacontrolveh.clasificacion_perdida_control=C;
coperdidacontrolveh=[anchocarril,curvatura2,delineacion,bandassonoras,estadosuperficie2,pendiente,resdeslizamiento2,tipomediana2,flujoext1,transitabilida,veloperacion1,C];
%Choque Frontal (adelantamiento) Coeficientes4
coadelantamientoveh.pendiente=pendiente;
coadelantamientoveh.resistencia_al_deslizamiento=resdeslizamiento2;
coadelantamientoveh.velocidades_diferenciales=velodiferencial;
coadelantamientoveh.numero_de_carriles=ncarriles2;
coadelantamientoveh.tipo_de_mediana=tipomediana3;
cero1=mat2str(cero);
cero2=str2double(cero1);
coadelantamientoveh.influencia_flujo_externo=cero2;
coadelantamientoveh.velocidad_operacion=veloperacion1;
coadelantamientoveh.clasificacion_adelantamiento=D;
coadelantamientoveh=[pendiente,resdeslizamiento2,velodiferencial,ncarriles2,tipomediana3,cero2,veloperacion1,D];
%Interseccion Coeficientes5
cointerseccionveh.tipo_de_interseccion=tipointer2;
cointerseccionveh.calidad_de_la_interseccion=calinter;
cointerseccionveh.pendiente=pendiente;
cointerseccionveh.alumbrado_publico=alumbrado1;
cointerseccionveh.resistencia_al_deslizamiento=resdeslizamiento2;
cointerseccionveh.distancia_visual=distvisual;
cointerseccionveh.canalizacion_de_la_interseccion=caninter;
cointerseccionveh.gestion_de_la_velocidad=gestvelo;
cointerseccionveh.tipo_de_interseccion_severidad=tipointer3;
cointerseccionveh.influencia_flujo_externo=volinter;
cointerseccionveh.velocidad_operacion=veloperacion1;
cointerseccionveh.clasificacion_Interseccion=E;
...
%puntacceso11=char(puntacceso1);
coaccesopropiedadesveh.puntos_de_acceso=puntacceso1;
coaccesopropiedadesveh.tipo_de_mediana=tipomediana4;
coaccesopropiedadesveh.via_de_acceso=vacceso;
coaccesopropiedadesveh.puntos_de_acceso_severidad=puntacceso2;
coaccesopropiedadesveh.influencia_flujo_externo=flujopre;
coaccesopropiedadesveh.velocidad_operacion=veloperacion1;
coaccesopropiedadesveh.clasificacion_Interseccion=F;
