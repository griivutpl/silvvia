...
disp('3 = Cerrada');
disp('4 = Muy cerrada');
curvatur=input('Ingresar curvatura : ');
...
disp('2 = Deficiente');
disp('3 = No Aplica');
calidadcurv=input('Ingresar calidad de curva : ');
if calidadcurv==1
    for i=1:4
...
disp('1 = Adecuado');
disp('2 = Deficiente');
delineacio=input('Ingresar delineacion : ');
if delineacio==1
    delineacion=1;
else delineacio==2
    delineacion=1.2;
...
disp('1 = Ausente');
disp('2 = Presente');
bandasonorae=input('Ingresar bandas sonoras en el espaldon : ');
if bandasonorae==1
    bandasonoraes=1.25;
else bandasonorae==2
    bandasonoraes=1;
...
disp('2 = Regular');
disp('3 = Mala');
estadosuperfici=input('Ingresar estado de la superficie : ');
...
pendient=input('Ingresar pendiente : ');
...
resdeslizamient=input('Ingresar resistencia al deslizamiento :');
...
distconducto=input('Ingresar distancia del lado conductor :');
...
objconducto=input('Ingresar objeto del lado conductor : ');
if objconducto==1
    for i=1:3
...
anchoespaldo=input('Ingresar ancho de espaldon lado conductor : ');
...
flujoex=input('Ingresar influencia del flujo externo (TPDA) : ');
if flujoex>=2000
    flujoext=0.5;
else flujoex<2000
     flujoext=0
...
disp('1 = Transitable')
disp('2 = No saturada')
transitabilidad=input('Ingresar transitabilidad : ');
...
veloperacio=input('Ingresar velocidad de operacion : ');
if veloperacio==150
    veloperacion=1;
...
distcopilot=input('Ingresar distancia del lado copiloto : ');
if distcopilot==1
    for i=1:3
...
%Severidad en la carretera: objeto del lado del conductor
objcopilot=input('Ingresar objeto del lado copiloto : ');
if objcopilot==1
    for i=1:3
...
%Ancho espaldones
anchoespaldonco=input('Ingresar ancho de espaldon del lado copiloto : ');
...
disp('1= Ausente')
disp('2 = Presente')
bandassonora=input('Ingresar bandas sonoras centrales : ');
if bandassonora==1
    bandassonoras=1.20;
else bandassonora==2
     bandassonoras=1;
...
tipomedian=input('Ingresar tipo de mediana central : ');
if tipomedian==1
    for i=1:4
...
disp('1 = Ausente');
disp('2 = Presente');
velodiferenci=input('Ingresar velocidades diferenciales : ');
if velodiferenci==1
    velodiferencial=1;
...
disp('5 = Dos y uno');
disp('6 = Tres y dos');
ncarrile=input('Ingresar numero de carriles : ');
if ncarrile==1
    for i=1:2
...
disp('16 = Minirotonda')
tipointe=input('Ingresar tipo de interseccion : ');
if tipointe==1
    for i=1:6
...
disp('2 = Deficiente')
disp('3 = No aplica')
calinte=input('Ingresar calidad de interseccion : ');
if calinte==1
    calinter=1;
elseif calinte==2
     calinter=1.2;
...
disp('1 = Ausente')
disp('2 = Presente')
alumbrad=input('Ingresar alumbrado publico : ');
if alumbrad==1
    for i=1:3
...
disp('1 = Adecuada');
disp('2 = Deficiente');
distvisua=input('Ingresar distancia visual : ');
if distvisua==1
    distvisual=1;
else distvisua==2
     distvisual=1.42;
...
disp('1 = Ausente');
disp('2 = Presente');
caninte=input('Ingresar canalizacion de la interseccion : ');
if caninte==1
    caninter=1.2;
else caninte==2
     caninter=1;
...
disp('1 = Ausente')
disp('2 = Presente')
gestvel=input('Ingresar gestion de la velocidad : ');
if gestvel==1
    gestvelo=1.25;
else gestvel==2 
     gestvelo=1;
...
volinte=input('Ingresar volumen en la interseccion : ')
...
disp('1 = Ausente')
disp('2 = Presente')
vacces=input('Ingresar via de servicio : ');
if vacces==1
    vacceso=1.5;
else vacces==2
        vacceso=1;
...
disp('4 = Ninguno')
puntacces=input('Ingresar puntos de acceso : ');
if puntacces==1
    for i=1:2
...
%Limite de velocidad
limitevelo=input('Ingresar velocidad limite : ');
if limitevelo==150
...
%Tipo de carretera
tipocarretera=input('Ingresar tipo de calzada : ')
...
disp('6 = Ninguno')
infmot=input('Ingresar infraestructura para motocicletas : ');
if infmot==1
    for i=1:2
    infmoto(1,i)=T20(1,i)
    end
...
pormoto=input('Ingresar porcentaje de motocicletas : ');
if pormoto==1 
        EstMoto=0;
elseif pormoto==2
        EstMoto=0;
...
infbic=input('Ingresar infraestructura para bicicletas : ');
if infbic==1
    for i=1:3
    infbici(1,i)=T21(1,i);
    end
...
disp('2 = Un lado')
disp('3 = Dos lados')
estve=input('Ingresar estacionamiento de vehiculos : ');
if estve==1
    estveh=1
elseif estve==2
    estveh=1.2
...
supescolar=input('Ingresar supervision escolar : ');
...
infcrucepe=input('Ingresar infraestructura de cruce peatonal : ')
...
porcicli=input('Ingresar porcentaje de ciclistas : ');
if porcicli==1
        EstCicl=0;
elseif porcicli==2
...
aceconducto=input('Ingresar acera del lado de conductor : ');
if aceconducto==1
    for i=1:2
...
disp('6 = Camino informal ? 1.0 m')
disp('7 = Camino informal de 0 m a <1.0 m')
acecopilot=input('Ingresar acera lado del copiloto : ');
if acecopilot==1
    for i=1:2
...
disp('2 = Pobre')
disp('3 = No aplica')
calicruc=input('Ingresar calidad del cruce peatonal : ');
if calicruc==1
    calicruce=1;
elseif calicruc==2
    calicruce=1.5;    
...
disp('1 = Presente')
disp('2 = Ausente')
valla=input('Ingresar vallas peatonales : ');
if valla==1
    vallap=1
else valla==2
    vallap=1.25
...
%Flujo peatonal en hora pico a lo largo de la carretera (lado del conductor)
porpeatoncon=input('Ingresar porcentaje de peatones lado conductor : ');
if porpeatoncon==1
        Y=0;
...
porpeatoncopi=input('Ingresar porcentaje de peatones lado copiloto : ');
if porpeatoncopi==1
        S=0;
...
porpeatoncru=input('Ingresar porcentaje de peatones hora pico : ');
if porpeatoncru==1 
    Z=0;
    U=0;
